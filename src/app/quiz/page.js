...
const QuizPage = () => {
  ...
  const handleAnswer = (option, selectedIndex) => {
          ...
          <div>
            ...
            <div className="w-full">
              <Card className="w-full py-4 px-4 flex flex-col gap-7">
                <CardHeader className="text-lg sm:text-lg md:text-3xl font-bold px-1 h-20">
                  <h1>
                ...
                <div className="flex flex-col gap-3">
                  <CardContent
                    onClick={() => handleAnswer(quiz.optionA, 0)}
                    className={cn(
                  ...
                  <CardContent
                    onClick={() => handleAnswer(quiz.optionB, 1)}
                    className={cn(
                      "border-2 border-slate-300 py-3 hover:bg-slate-300 cursor-pointer",
                      selected === 1
                        ? "bg-blue-600 hover:bg-blue-600"
                  ...
                  <CardContent
                    onClick={() => handleAnswer(quiz.optionC, 2)}
                    className={cn(
                      "border-2 border-slate-300 py-3 hover:bg-slate-300 cursor-pointer",
                      selected === 2
                        ? "bg-blue-600 hover:bg-blue-600"
                  ...
                  <CardContent
                    onClick={() => handleAnswer(quiz.optionD, 3)}
                    className={cn(
                      "border-2 border-slate-300 py-3 hover:bg-slate-300 cursor-pointer",
                      selected === 3
                        ? "bg-blue-600 hover:bg-blue-600"
                ...
                <div className="w-full float-end">
                  <Button
                    className="w-full md:w-[100px] py-6 hover:bg-gradient-to-r hover:from-blue-600 hover:to-fuchsia-600"
                    onClick={handleNext}
                  >
                    Next
                  </Button>
          ...
          <div className="flex flex-col justify-center items-center h-screen">
            <div className="bg-gradient-to-r from-blue-600 to-fuchsia-600 p-[3px] rounded-md">
              <Card>
                ...
                <CardContent className="text-2xl font-bold">
                  <h1>Percentage: {(score / data.length) * 100}%</h1>
                </CardContent>
                <CardFooter>
                  <Button
                    className="hover:bg-gradient-to-r hover:from-blue-600 hover:to-fuchsia-600"
                    onClick={() => {
                      setIndex(0);
                      setScore(0);
                    }}
